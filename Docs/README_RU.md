...
|---|---|---|
| **Live** | ноутбук, повседневная работа | облачные службы, GigaAM, whisper.cpp, разделение по говорящим при известном их числе |
| Studio | рабочая станция с видеокартой NVIDIA | то же плюс CUDA и автоматическое разделение по говорящим |
