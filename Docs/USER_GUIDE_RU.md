...
В раздачу не входят веса моделей: кэш GigaAM и пакет whisper.cpp — вместе почти
пять гигабайт. У весов свои лицензии, отдельные от лицензии программы, поэтому
...
3. Установить FFmpeg.
4. Запустить GUI: он сам проверит Live dependencies и при необходимости установит их из `install\wheels\live` без сети. Ручная кнопка остаётся для repair.
